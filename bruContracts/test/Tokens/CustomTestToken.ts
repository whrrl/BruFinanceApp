...
import {deploy, PROXIES, SIGNERS, CONTRACTS, CONSTANTS, IMPLEMENTATION_CONTRACTS, getProposalCounter, increaseProposalCounter, deployImplementationContracts} from "./../shared/deploy-1";
...
describe("TestToken Contract Tests", async () => {
    ...
    it("should have 6 decimal", async () => {
        let decimal = await CONTRACTS.TestTokenContract.decimals();
        expect(decimal).to.be.equal(6);
    });
