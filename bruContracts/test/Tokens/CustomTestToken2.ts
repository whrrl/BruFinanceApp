...
import {deploy, PROXIES, SIGNERS, CONTRACTS, CONSTANTS, IMPLEMENTATION_CONTRACTS, getProposalCounter, increaseProposalCounter, deployImplementationContracts} from "./../shared/deploy-2";
...
describe("TestToken Contract Tests", async () => {
    ...
    it("should have 30 decimal", async () => {
        let decimal = await CONTRACTS.TestTokenContract.decimals();
        expect(decimal).to.be.equal(30);
    });
